    ...
    <section className="bg-white border-b border-line">
      <div className="mx-auto max-w-7xl px-4 py-12 md:py-16 grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="mt-4 text-ink/70 max-w-prose">Descoperă tehnici profesionale, compoziții premium și ghiduri moderne pentru aranjamente florale, ghivece și decor, create de experți pentru piața din România.</p>
        ...
        <div className="aspect-[16/9] md:aspect-[4/3] rounded-2xl overflow-hidden border border-line bg-bgsoft">
          <img src="/blog/ghivece-ceramice-premium-2025.jpg" className="h-full w-full object-cover" alt="Ghivece Ceramice Premium România 2025" />
        </div>
      </div>
    </section>
  );
