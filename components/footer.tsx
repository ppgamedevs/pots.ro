    ...
    <footer className="border-t mt-10">
      <div className="mx-auto max-w-6xl px-4 py-10 grid gap-6 md:grid-cols-3 text-sm">
        <div>
          ...
          <p className="text-slate-600">Marketplace românesc pentru produse de floristică.</p>
        </div>
        <div>
      ...
      <div className="text-center text-xs text-slate-500 pb-6">© {new Date().getFullYear()} Pots.ro</div>
    </footer>
  );
}
