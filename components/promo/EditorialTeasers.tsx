    ...
    <section className="py-8 lg:py-12 bg-bg">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-semibold text-ink mb-2">Ghiduri Expert Aranjamente Florale România 2025</h2>
          <p className="text-muted">Descoperă ghiduri avansate pentru aranjamente florale moderne, tehnici profesionale și compoziții premium adaptate pieței din România</p>
        </div>
